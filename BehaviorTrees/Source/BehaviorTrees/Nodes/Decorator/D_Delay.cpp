...
*---------------------------------------------------------------------------*/
D_DelayData *D_Delay::GetLocalBlackBoard(NodeData *nodedata_ptr)
{
	return nodedata_ptr->GetLocalBlackBoard<D_DelayData>();
}
...
Returns:        None.
*---------------------------------------------------------------------------*/
void D_Delay::InitialLocalBlackBoard(NodeData *nodedata_ptr)
{
...
{
	D_DelayData *customdata = GetLocalBlackBoard(nodedata_ptr);
